...
/**
 * The SCIM settings UI. Rendered ONLY by ./page.tsx, which refuses server-side
 * unless scim_provisioning is enabled for the org (BACKLOG-3087). Do not route
 * to this component from anywhere else — it carries no gate of its own.
 */
export default function ScimSettingsClient() {
