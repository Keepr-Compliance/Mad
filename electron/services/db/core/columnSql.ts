...
export const COLUMN_SQL = {
  ...
  commission_actual_rate: sql`commission_actual_rate`,
  commission_adjustment_reason: sql`commission_adjustment_reason`,
  commission_gross_amount: sql`commission_gross_amount`,
  commission_offered_rate: sql`commission_offered_rate`,
  company: sql`company`,
