 ...
 *
 * FOUR sections above — PR 1, PR 2, PR 3 and the PR 4 note directly above this one —
 * say four of BACKLOG-3044's remaining escapes CANNOT convert, because they splice
 * `LIVE_TRANSACTION_SQL_PREDICATE` and that fragment hand-quoted a status VALUE into
 * SQL text. **That was true when written and is now false**, and the
 ...
 * `importPlanInputs.ts` stays at 1, so PR 4's count of 26 remaining in 3 files is
