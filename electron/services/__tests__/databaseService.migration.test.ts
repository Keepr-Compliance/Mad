...
describe("DatabaseService Migration Robustness (TASK-2048)", () => {
  ...
  describe("dry-run mode", () => {
    ...
    it("should report zero pending when all applied", async () => {
      ...
      // Setup: version = 54 (all applied, including BACKLOG-2300 v54 sync_session_id indexes)
      mockStatement.get
        .mockReturnValueOnce({ name: "schema_version" })
        .mockReturnValueOnce({ version: 54 });
  ...
  describe("happy path", () => {
    it("should run all pending migrations in sequence", async () => {
      ...
      // Transaction should have been called twenty-four times (for migrations 30-53;
      ...
      expect(mockDb.transaction).toHaveBeenCalledTimes(25);
    });
    ...
    it("should skip already-applied migrations", async () => {
      ...
      // version = 54, all migrations applied (including BACKLOG-2300 v54)
      mockStatement.get
        .mockReturnValueOnce({ name: "schema_version" })
        .mockReturnValueOnce({ version: 54 });
