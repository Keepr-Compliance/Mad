...
export function buildFirstRunNotice(paths: AppliedAppDataPaths): {
  ...
  return {
    ...
    detail: [
      ...
      "",
      "You will be asked to sign in, and there will be no transactions or",
      "contacts yet. That is expected — this is a separate, brand-new profile,",
      "NOT data loss. Development builds used to open your real database",
      "directly, which is how the v2.28.0 upgrade got consumed before it could",
      "be tested.",
      "",
