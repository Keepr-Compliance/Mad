                  ...
                  <ul>
                    {results.emails.items.map((e) => (
                      <li key={e.id} className="border-b border-gray-50 last:border-0">
                        <button
                          type="button"
                          onClick={() => { console.debug("[1869-DEBUG] LinkedContentSearch email onClick: emailId=", e.id); onNavigateEmail(e.id); }}
                  ...
                  <ul>
                    {results.texts.items.map((t) => (
                      <li key={t.id} className="border-b border-gray-50 last:border-0">
                        <button
                          type="button"
                          onClick={() => { console.debug("[1869-DEBUG] LinkedContentSearch text onClick: textId=", t.id); onNavigateText(t.id); }}
