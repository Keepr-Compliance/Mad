-- mutant m31-guard-exempts-every-caller (generated by generate.mjs from supabase/migrations/20260925073000_backlog_3477_submission_checklist_review.sql; do not edit)
-- targets: c13
...
DECLARE
  ...
  i         integer;
BEGIN
  IF v_role IS NULL OR v_role IN ('service_role', 'authenticated') THEN
    RETURN NEW;
  END IF;
