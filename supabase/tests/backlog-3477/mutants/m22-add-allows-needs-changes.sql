-- mutant m22-add-allows-needs-changes (generated by generate.mjs from supabase/migrations/20260925073000_backlog_3477_submission_checklist_review.sql; do not edit)
-- targets: c08
...
BEGIN
  ...
  IF NOT COALESCE((public.check_feature_access(v_sub.organization_id, 'transaction_checklists') ->> 'allowed')::boolean, false) THEN
    RAISE EXCEPTION 'not_authorized' USING ERRCODE = '42501';
  END IF;
  IF v_sub.status IS NULL OR v_sub.status NOT IN ('submitted', 'resubmitted', 'under_review', 'needs_changes') THEN
    RAISE EXCEPTION 'not_open_for_review' USING ERRCODE = '42501';
  END IF;
