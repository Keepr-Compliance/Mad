-- mutant m09-snapshot-first-attachment-only (generated by generate.mjs from supabase/migrations/20260925073000_backlog_3477_submission_checklist_review.sql; do not edit)
-- targets: c01
    ...
    FOR it IN SELECT e.value FROM jsonb_array_elements(COALESCE(c -> 'items', '[]'::jsonb)) AS e(value) LOOP
      ...
      FOR lk IN SELECT e.value FROM jsonb_array_elements(COALESCE(it -> 'links', '[]'::jsonb)) AS e(value) LOOP
        ...
        IF v_kind = 'attachment' THEN
          SELECT COALESCE((array_agg(a.id))[1:1], '{}'), v_asked - count(DISTINCT a.local_attachment_id)::integer
