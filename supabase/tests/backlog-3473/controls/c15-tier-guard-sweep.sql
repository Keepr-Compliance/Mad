...
--                                                 false override         (NOT load-bearing:
--                                                 E is enterprise, no guard mutant can change it)
--   15.6  T1 x sso_login (ON)                     false plan ignored
--   15.7  T1 x call_log (ON)                      true override
--   15.8  I  x call_log (ON)                      false plan ignored
--   15.9  I  x desktop_hide_from_export (ON)      true override
--   15.10 I  x voice_transcription (OFF)          false override
--   15.11 C  x sso_login (ON), C on a custom plan  true override
...
-- m28 (helper narrowed to transaction_checklists), m29 (ignores min_tier),
...
INSERT INTO t3473_c15 VALUES
  ...
  ('15.6',  'o_t1', 'u_t1_agent', 'sso_login',                '{"enabled": false, "source": "plan", "override_ignored": true}'),
  ('15.7',  'o_t1', 'u_t1_agent', 'call_log',                 '{"enabled": true, "source": "override"}'),
  ('15.8',  'o_i',  'u_i',        'call_log',                 '{"enabled": false, "source": "plan", "override_ignored": true}'),
  ('15.9',  'o_i',  'u_i',        'desktop_hide_from_export', '{"enabled": true, "source": "override"}'),
  ('15.10', 'o_i',  'u_i',        'voice_transcription',      '{"enabled": false, "source": "override"}'),
  ('15.11', 'o_c',  'u_c_member', 'sso_login',                '{"enabled": true, "source": "override"}');
...
INSERT INTO t3473_c15 VALUES
  ('15.5', 'o_e', 'u_e_agent', 'transaction_checklists', '{"enabled": false, "source": "override"}');
